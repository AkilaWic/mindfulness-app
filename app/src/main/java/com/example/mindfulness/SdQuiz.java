...
public class SdQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int totalQuestion = SdQnA.question.length;
...
//
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals("")) {
                ...
                if (selectedAnswer.equals(SdQnA.correctAnswers[questionOrderList.get(currentQuestionIndex)])) {
                    score++;
                }
            ...
            int greenColor = ContextCompat.getColor(this, R.color.teal_200);

            clickedButton.setBackgroundColor(greenColor);
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(SdQnA.question[questionIndex]);
        ansA.setText(SdQnA.choices[questionIndex][0]);
        ansB.setText(SdQnA.choices[questionIndex][1]);
        ansC.setText(SdQnA.choices[questionIndex][2]);
        ansD.setText(SdQnA.choices[questionIndex][3]);
    }
