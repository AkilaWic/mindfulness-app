...
public class ManiaQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals("")) {
                ...
                if (selectedAnswer.equals(ManiaQnA.correctAnswers[questionOrderList.get(currentQuestionIndex)])) {
                    score++;
                }
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(ManiaQnA.question[questionIndex]);
        ansA.setText(ManiaQnA.choices[questionIndex][0]);
        ansB.setText(ManiaQnA.choices[questionIndex][1]);
        ansC.setText(ManiaQnA.choices[questionIndex][2]);
        ansD.setText(ManiaQnA.choices[questionIndex][3]);
    }
