...
public class StressQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals("")) {
                ...
                if (selectedAnswer.equals(StressQnA.correctAnswers[questionOrderList.get(currentQuestionIndex)])) {
                    score++;
                }
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(StressQnA.question[questionIndex]);
        ansA.setText(StressQnA.choices[questionIndex][0]);
        ansB.setText(StressQnA.choices[questionIndex][1]);
        ansC.setText(StressQnA.choices[questionIndex][2]);
        ansD.setText(StressQnA.choices[questionIndex][3]);
    }
