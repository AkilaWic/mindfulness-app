...
public class PdQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals("")) {
                ...
                if (selectedAnswer.equals(PdQnA.correctAnswers[questionOrderList.get(currentQuestionIndex)])) {
                    score++;
                }
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(PdQnA.question[questionIndex]);
        ansA.setText(PdQnA.choices[questionIndex][0]);
        ansB.setText(PdQnA.choices[questionIndex][1]);
        ansC.setText(PdQnA.choices[questionIndex][2]);
        ansD.setText(PdQnA.choices[questionIndex][3]);
    }
