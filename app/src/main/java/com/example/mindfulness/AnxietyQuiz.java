...
public class AnxietyQuiz extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int totalQuestion = AnxietyQnA.question.length;
    ...
    public void onClick(View view) {
        ...
        if (clickedButton.getId() == R.id.submit_btn) {
            if (selectedAnswer.equals("")) {
                ...
                if (selectedAnswer.equals(AnxietyQnA.correctAnswers[questionOrderList.get(currentQuestionIndex)])) {
                    score++;
                }
    ...
    void loadNewQuestion() {
        ...
        questionTextView.setText(AnxietyQnA.question[questionIndex]);
        ansA.setText(AnxietyQnA.choices[questionIndex][0]);
        ansB.setText(AnxietyQnA.choices[questionIndex][1]);
        ansC.setText(AnxietyQnA.choices[questionIndex][2]);
        ansD.setText(AnxietyQnA.choices[questionIndex][3]);
    }
